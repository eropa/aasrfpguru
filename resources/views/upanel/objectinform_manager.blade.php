...
@section('headURL')
    <ol class="breadcrumb">
        ...
        @if ($id > 0)
            <li class="breadcrumb-item active" aria-current="page">Управление данными "Барьеры защиты" (Изменить)</li>
        @else
            <li class="breadcrumb-item active" aria-current="page">Управление данными "Барьеры защиты" (Добавление)</li>
        @endif
    </ol>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" href="{{ route('managersecuriteb_add_save') }}">
                        @if ($id > 0)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                    <textarea class="form-control" id="exampleTextarea" rows="5"
                                              name="AboutText">@if ($id > 0){{ $datas->AboutSecurity }}@endif</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <select multiple class="form-control" id="exampleSelect2" name="mIstochnik[]">
                                @if ($id > 0)
                                    @foreach($datasIstohniks as $dataIstochnik)
